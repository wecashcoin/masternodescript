...
4. Send 10000 WCH to this address and wait for at least 1 confirmation
...
```
bash <( curl -sL https://raw.githubusercontent.com/wecashcoin/masternodescript/main/install.sh)
```
...
```<alias> <ip>:38244 <private_key> <tx_id> <index>```
3. It should look something like this:
``` MN1 127.0.0.2:38244 XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX X```
...
3. Enter ```wch-cli getmasternodestatus```
4. This will tell you the status of your masternode, any questions, Join discord for help: https://discord.gg/8wPuMxGv
